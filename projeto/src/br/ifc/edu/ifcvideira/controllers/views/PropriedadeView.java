		...
		table.getColumnModel().getColumn(2).setPreferredWidth(60);
			...
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					//O tamanho do reflorestamento tem que ser maior de 10%, se n„o, a multa ser· 2.000 para ·rea 
					...
					if(tamanhor<(tamanhop/10)) {						
						...
						if(p.getMulta()!=0) {
							JOptionPane.showMessageDialog(null, "VocÍ tem uma multa de R$2.000,00!");
						}
